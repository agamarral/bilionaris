...
var svgWorldMap = (function() { 
    ...
    var options = {
        ...
        containerId: '', // if the map has to be created inside a given container, this property shall contain its id
        // Color options
        oceanColor: '#D8EBFF', 
        worldColor: '#FFFFFF', 
    ...
    function initMap() {
        ...
        if (document.getElementById('svg-world-map-container') == null) {
            ...
            if (options.containerId == '' || document.getElementById(options.containerId) == null) {
            ...
            style.innerHTML = `#svg-world-map-container, #svg-world-map`;
    ...
    var speed = 20; // For ticks per date
    var timeData = false;
    var maxDates = false;
    var loop = false;
    var paused = true;
    ...
    function updateControls() {
        ...
        if (timeData && timeData.length > 0) {
            ...
            document.getElementById("map-date").innerHTML = "Any " + dateKey;
